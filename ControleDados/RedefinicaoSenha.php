<?php
	...
	Class MailjetMailRedefine
	{
		public function emailPostForgotPass($nameUser, $emailUser, $passUser)
		{
	...
	function redefinirSenha() {
		...
		if (existeEmail($email)) {
			...
			$emailSender= new MailjetMailRedefine;
			$emailSender->emailPostForgotPass($nomeUsuario, $email, $senha);
